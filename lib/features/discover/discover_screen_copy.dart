...
class ChallengeDiscoverScreen extends StatefulWidget {
  const ChallengeDiscoverScreen({super.key});

  @override
  State<ChallengeDiscoverScreen> createState() =>
      _ChallengeDiscoverScreenState();
}

class _ChallengeDiscoverScreenState extends State<ChallengeDiscoverScreen>
